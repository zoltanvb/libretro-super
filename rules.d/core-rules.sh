...
libretro_irogb_build_rule="cmake"
libretro_irogb_build_args="-DBUILD_LIBRETRO=ON -DNO_CORE_FILESYSTEM=ON"
...
libretro_virtualxt_git_url="https://codeberg.org/virtualxt/virtualxt.git"
